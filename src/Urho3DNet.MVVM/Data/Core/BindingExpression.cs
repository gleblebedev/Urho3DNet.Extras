...
namespace Urho3DNet.MVVM.Data.Core
{
    ...
    public class BindingExpression : LightweightObservableBase<object>, ISubject<object>, IDescription
    {
        ...
        public BindingExpression(
            ...
            : this(inner, targetType, UrhoProperty.UnsetValue, UrhoProperty.UnsetValue, converter, converterParameter, priority)
        {
        }
        ...
        public void OnNext(object value)
        {
            ...
            using (_inner.Subscribe(_ => { }))
            {
                ...
                if (type != null)
                {
                    ...
                    if (converted == UrhoProperty.UnsetValue)
                    {
        ...
        {
            if (value == null && _targetNullValue != UrhoProperty.UnsetValue)
            {
            ...
            if (notification == null)
            {
                ...
                if (_fallbackValue != UrhoProperty.UnsetValue &&
                    (converted == UrhoProperty.UnsetValue || converted is BindingNotification))
                {
        ...
        private BindingNotification ConvertValue(BindingNotification notification)
        {
            ...
            else if (_fallbackValue != UrhoProperty.UnsetValue)
            {
                var fallback = ConvertFallback();
        ...
        private BindingNotification ConvertFallback()
        {
            ...
            if (_fallbackValue == UrhoProperty.UnsetValue)
            {
                throw new UrhoInternalException("Cannot call ConvertFallback with no fallback value");
            }
