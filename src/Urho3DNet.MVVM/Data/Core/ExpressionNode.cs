...
namespace Urho3DNet.MVVM.Data.Core
{
    public abstract class ExpressionNode
    {
        ...
        protected static readonly WeakReference<object> UnsetReference = 
            new WeakReference<object>(UrhoProperty.UnsetValue);
        ...
        public void Subscribe(Action<object> subscriber)
        {
            if (_subscriber != null)
            {
                throw new UrhoInternalException("ExpressionNode can only be subscribed once.");
            }
        ...
        private void StartListening()
        {
            ...
            else if (target != UrhoProperty.UnsetValue)
            {
                _listening = true;
            ...
            {
                ValueChanged(UrhoProperty.UnsetValue, notify:false);
                _listening = false;
            }
        }
