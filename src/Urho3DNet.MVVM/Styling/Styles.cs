...
namespace Urho3DNet.MVVM.Styling
{
    ...
    /// </summary>
    public class Styles : ObjectView,
        IUrhoList<IStyle>,
        IStyle,
        IResourceProvider
    {
        private readonly UrhoList<IStyle> _styles = new UrhoList<IStyle>();
        private IResourceHost? _owner;
        private IResourceDictionary? _resources;
        private Dictionary<Type, List<IStyle>?>? _cache;

        public Styles(Object target) : base(target)
        {
            _styles.ResetBehavior = ResetBehavior.Remove;
            _styles.CollectionChanged += OnCollectionChanged;
        }

        public Styles(IResourceHost owner, Object target) : this(target)
        {
            Owner = owner;
        }
        ...
        public UrhoList<IStyle>.Enumerator GetEnumerator() => _styles.GetEnumerator();
