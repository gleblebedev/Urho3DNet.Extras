...
namespace Urho3DNet
{
    public static class AvaloniaExtensionMethods
    {
        ...
        public static void Show(this Avalonia.Controls.Window window, Urho3DNet.UIElement parent)
        {
            window.GetUIElement().SetParent(parent);
            window.Show();
        }
        
        public static void Show(this Avalonia.Controls.Window window, Urho3DNet.Texture2D dynamicTexture)
        {
