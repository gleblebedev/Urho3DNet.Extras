...
namespace Urho3DNet
{
    public class AvaloniaElement : Sprite
    {
        ...
        public AvaloniaElement(Context context) : base(context)
        {
            ...
            _eventAdapter.Click += OnClick;
            _eventAdapter.UIMouseClick += OnMouseClick;
        }

        private void OnMouseClick(object sender, UIEventsAdapter.UIMouseClickEventArgs e)
        {
            
        }

        private void OnClick(object sender, UIEventsAdapter.ClickEventArgs e)
        {
